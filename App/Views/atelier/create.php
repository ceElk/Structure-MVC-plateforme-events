<h1 class="mb-4">Créer un atelier</h1>
...
<form method="POST" enctype="multipart/form-data" class="card p-4 shadow-sm">
    ...
    <!-- ✅ AJOUTE ÇA : SÉLECTEUR DE CATÉGORIE -->
    <div class="mb-3">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="number" name="available_spots" class="form-control" value="20">
        </div>
    ...
    <div class="d-flex gap-2">
        ...
        <a href="?controller=atelier&action=index" class="btn btn-secondary">
            ↩ Retour
        </a>
    </div>
